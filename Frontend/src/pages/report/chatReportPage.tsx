    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <div className={styles.index}>
          <p className={styles.index__item}>대화 기록</p>
          <p className={styles.index__item}>총평</p>
        </div>
        ...
        <div className={styles.report}>
          ...
          <div className={styles.report__history}>
            <p className={styles.report__sub}>대화 기록</p>
          ...
          <div className={styles.report__commentary}>
            <p className={styles.report__sub}>총평</p>
          ...
          <div className={styles.report__feedback}>
            <p className={styles.report__sub}>상대방의 평가</p>
