...
if [ -z "$EXIST_GITCHAN" ]; then
        echo "8081 컨테이너 실행"
        sudo docker compose -p blue-8081 -f /home/ubuntu/docker-compose.blue8081.yml up -d --force-recreate
        BEFORE_COLOR="8082"
        AFTER_COLOR="8081"
        BEFORE_PORT=8082
        AFTER_PORT=8081
        ...
        echo "8082 컨테이너 실행"
        sudo docker compose -p green-8082 -f /home/ubuntu/docker-compose.green8082.yml up -d --force-recreate
        BEFORE_COLOR="8081"
        AFTER_COLOR="8082"
        BEFORE_PORT=8081
        AFTER_PORT=8082
