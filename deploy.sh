...
# 0. 이미지 갱신
echo "새로운 이미지를 가져옵니다..."
docker-compose -p bluegreen-8081 -f /home/ubuntu/S12P11D201/Backend/docker-compose.bluegreen8081.yml pull
docker-compose -p bluegreen-8082 -f /home/ubuntu/S12P11D201/Backend/docker-compose.bluegreen8082.yml pull
docker-compose -p bluegreen-8083 -f /home/ubuntu/S12P11D201/BackendAI/docker-compose.bluegreen8083.yml pull
docker-compose -p bluegreen-8084 -f /home/ubuntu/S12P11D201/BackendAI/docker-compose.bluegreen8084.yml pull
docker-compose -p my-react -f /home/ubuntu/S12P11D201/Frontend/docker-compose.yml pull
...
# Blue-Green 배포 환경 전환
EXIST_GITCHAN=$(docker-compose -p bluegreen-8081 -f /home/ubuntu/S12P11D201/Backend/docker-compose.bluegreen8081.yml ps | grep Up)
...
if [ -z "$EXIST_GITCHAN" ]; then
    ...
    docker-compose -p bluegreen-8081 -f /home/ubuntu/S12P11D201/Backend/docker-compose.bluegreen8081.yml up -d --build
    docker-compose -p bluegreen-8083 -f /home/ubuntu/S12P11D201/BackendAI/docker-compose.bluegreen8083.yml up -d --build
    BEFORE_S_COLOR="8082"
    AFTER_S_COLOR="8081"
    BEFORE_S_PORT=8082
    AFTER_S_PORT=8081
    ...
    docker-compose -p bluegreen-8082 -f /home/ubuntu/S12P11D201/Backend/docker-compose.bluegreen8082.yml up -d --build
    docker-compose -p bluegreen-8084 -f /home/ubuntu/S12P11D201/BackendAI/docker-compose.bluegreen8084.yml up -d --build
    BEFORE_S_COLOR="8081"
    AFTER_S_COLOR="8082"
    BEFORE_S_PORT=8081
    AFTER_S_PORT=8082
...
docker-compose -p my-react -f /home/ubuntu/S12P11D201/Frontend/docker-compose.yml up -d --force-recreate --remove-orphans
...
docker-compose -p bluegreen-${BEFORE_S_COLOR} -f /home/ubuntu/S12P11D201/Backend/docker-compose.bluegreen${BEFORE_S_COLOR}.yml down
docker-compose -p bluegreen-${BEFORE_D_COLOR} -f /home/ubuntu/S12P11D201/BackendAI/docker-compose.bluegreen${BEFORE_D_COLOR}.yml down
